...
const consentTypes = [
  {
    ...
    desc: 'Procedure details, risks, alternatives, and surgeon declaration — all structured and legally correct. Arabic & English versions simultaneously generated.',
    badges: ['DHA Compliant', 'JCI Aligned'],
  },
  {
    title: 'Anaesthetic Consent',
    desc: 'Pre-anaesthetic assessment, agent disclosure, risk stratification, and complication — standardised to DHA and HAAD specifications.',
    badges: ['HAAD Compliant'],
  },
  {
  ...
  },
  {
    ...
    desc: 'Financial agreements, data sharing, treatment authority — complete digital consents delivered to patient\'s phone. Must-have for any HAAD facility.',
...
const steps = [
  ...
  },
  {
    ...
    desc: 'Consent form sent to patient\'s mobile in preferred language. Arabic/English consent forms auto-translated in seconds.',
  },
  {
    num: '3',
    icon: Fingerprint,
  ...
  },
  {
    ...
    desc: 'Complete document, signed and stored. Accessible for all. Audit compliance built in. Available for DHA, JCI inspection at a single click.',
  },
  {
    num: '5',
    icon: TriangleAlert,
...
const badgeColor = (b) => {
  if (b === 'DHA Compliant') return 'bg-blue-50 text-blue-700'
  if (b === 'HAAD Compliant') return 'bg-purple-50 text-purple-700'
  if (b === 'JCI Aligned') return 'bg-amber-50 text-amber-700'
                ...
                return (
                  <div key={step.num} className="flex gap-4">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-9 h-9 rounded-full bg-[#142e1e] text-[#4ade80] flex items-center justify-center text-xs font-black shrink-0">
                        {step.num}
                      </div>
                      {i < steps.length - 1 && (
